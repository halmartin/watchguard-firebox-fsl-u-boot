...
#define REG_PORT_BASE_AMETHYST			0
...
#define PORT_PCS_CTRL_EEE				BIT(9)
#define PORT_PCS_CTRL_FORCE_EEE			BIT(8)
...
#define PORT_SWITCH_ID_PROD_NUM_6361		0x261
#define PORT_SWITCH_ID_PROD_NUM_6193X		0x193
#define PORT_SWITCH_ID_PROD_NUM_6191X		0x192
#define PORT_SWITCH_ID_PROD_NUM_6393X		0x393
...
struct mv88e6xxx_dev {
	...
	int fix_port;	/* These are ports without PHYs that may be wired directly to other serdes interfaces */
	int led_mode;
};
