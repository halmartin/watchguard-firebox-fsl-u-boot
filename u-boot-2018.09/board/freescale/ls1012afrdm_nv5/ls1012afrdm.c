...
#ifdef CONFIG_TARGET_LS1012AFRWY_WG_NV5
...
int board_init(void)
{
	...
	/* SENAO: init gpio */
	gpio_direction_input(120); /* INT_88E6361_n */
	gpio_direction_input(116); /* FACTORY_RST_N */
	gpio_direction_output(117, 0); /* CPU_CKSTP_OUT_STATUS_LED */
	gpio_direction_output(118, 0); /* CPU_MODE_LED */
	gpio_direction_output(119, 0); /* CPU_CKSTP_IN_ATTN_LED */
	gpio_direction_input(115); /* USB_FLG_n */
	gpio_direction_input(121); /* IRQ_TPM_n */
	gpio_direction_output(123, 1); /* CPU_TPM_RSTn */
	gpio_direction_output(122, 0); /* CPU_FAILOVER_LED */
