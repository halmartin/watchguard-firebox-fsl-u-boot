...
dimm_params_t ddr_raw_timing = {
	...
	.tras_ps = 32000,				// p.262 28 nCK
	.trc_ps = 45750,				// p.262 39 nCK
#endif	
	...
	.tccdl_ps = 6250,				// p.61
#else
	.tfaw_ps = 21000,				// p.282 20 nCK
	.trrds_ps = 3000,				// p.282 4 nCK
	.trrdl_ps = 4900,				// p.282 5 nCK
	.tccdl_ps = 5000,				// p.282 5 nCK
#endif	
...
#else
	printf("Initializing DDR...(ddr_raw_timing.tckmax_ps = %d, ddr_raw_timing.tccdl_ps = %d)\n", ddr_raw_timing.tckmax_ps, ddr_raw_timing.tccdl_ps);
#endif
